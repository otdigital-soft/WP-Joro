...
if ( function_exists( 'acf_add_options_page' ) ) {
	...
	acf_add_options_page(
		array(
			'page_title' => 'Joro Settings',
			'menu_title' => 'Joro Settings',
			'menu_slug'  => 'joro-settings',
...
register_nav_menus(
	array(
		'headermenu'       => __( 'Header Navigation', 'am' ),
		'footermenu'       => __( 'Footer Navigation', 'am' ),
		'footerbottommenu' => __( 'Footer Bottom Navigation', 'am' ),
	)
);
