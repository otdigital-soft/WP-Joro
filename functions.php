...
require get_parent_theme_file_path( '/inc/fn-custom.php' );
...
// Optimize functions
require get_parent_theme_file_path( '/inc/fn-optimize.php' );

/* ACF Custom */
require get_parent_theme_file_path( '/inc/acf/acf-extras.php' );
require get_parent_theme_file_path( '/inc/acf/acf-to-search.php' );